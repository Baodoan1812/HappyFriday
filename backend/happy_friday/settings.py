"""
Django settings for happy_friday project.
...
SECRET_KEY = 'django-insecure-rgtx2h#j8atfijdscaf4+q%)x8xd7mhqoa=_t+z#)l@&y3_f+b'
...
ROOT_URLCONF = 'happy_friday.urls'
...
WSGI_APPLICATION = 'happy_friday.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('DB_HOST', 'db'),  # "db" = tên service trong docker-compose
